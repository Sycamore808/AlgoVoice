...
class EmailNotifier:
    ...
    def send_alert_email(
        ...
        Returns:
            是否发送成功
        """
        subject = f"[AlgoVoice Alert] {alert_type}"
    ...
    def send_report_email(
        ...
        Returns:
            是否发送成功
        """
        subject = f"[AlgoVoice Report] {report_type.upper()} Report"
    ...
    def _generate_alert_body(
        ...
        """
        lines = [
            f"AlgoVoice Alert Notification",
            f"",
        ...
        lines.extend(
            [
                "",
                "---",
                "This is an automated message from AlgoVoice Monitoring System.",
    ...
    def _generate_alert_html(
        ...
        html += """
                <div class="footer">
                    This is an automated message from AlgoVoice Monitoring System.<br/>
                    Please do not reply to this email.
                </div>
            </div>
        </body>
    ...
    def _generate_report_body(
        ...
        lines.extend(
            [
                ...
                "",
                "---",
                "This is an automated message from AlgoVoice Reporting System.",
            ]
        )
