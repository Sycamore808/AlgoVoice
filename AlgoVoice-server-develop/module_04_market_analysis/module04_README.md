...
数据库会在首次使用时自动创建，位置：
```
C:\Users\Sycamore\Desktop\AlgoVoice\AlgoVoice-server-develop/data/module04_market_analysis.db
```
...
Database: C:\Users\Sycamore\Desktop\AlgoVoice\AlgoVoice-server-develop/data/module04_market_analysis.db
============================================================
