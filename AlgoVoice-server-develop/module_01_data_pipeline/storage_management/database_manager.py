...
class DatabaseManager:
    ...
    def __init__(self, db_path: str = None):
        ...
        if db_path is None:
            import os
            db_path = os.path.join("data", "AlgoVoice.db")
...
# 便捷函数
def create_database_manager(db_path: str = "data/AlgoVoice.db") -> DatabaseManager:
    """创建数据库管理器的便捷函数
...
def get_database_manager(db_path: str = "data/AlgoVoice.db") -> DatabaseManager:
    """获取全局数据库管理器实例（单例模式）
