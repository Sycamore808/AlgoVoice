...
数据库会在首次使用时自动创建，位置：
```
C:\Users\Sycamore\Desktop\Finloom\FinLoom-server-develop/data/module04_market_analysis.db
```
...
# 进入项目目录
cd C:\Users\Sycamore\Desktop\Finloom\FinLoom-server-develop
...
Database: C:\Users\Sycamore\Desktop\Finloom\FinLoom-server-develop/data/module04_market_analysis.db
============================================================
